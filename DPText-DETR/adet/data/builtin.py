...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "mpsc_train": ("MPSC/image/train", "MPSC/annotation/train.json"),
    #-------------------------------------------------------------------------------------------------------
    ...
    "mpsc_test": ("MPSC/image/test", "MPSC/annotation/test.json"),
    "mpsc_test_rotate": ("MPSC/image/test_rotate", "MPSC/annotation/rotate_test.json"),
    "mpsc_test_contrast_10" : ("MPSC/image/test_contrast_10", "MPSC/annotation/test_contrast_10.json"),
    "mpsc_test_contrast_20" : ("MPSC/image/test_contrast_20", "MPSC/annotation/test_contrast_20.json"),
    "mpsc_test_contrast_30" : ("MPSC/image/test_contrast_30", "MPSC/annotation/test_contrast_30.json")
}
